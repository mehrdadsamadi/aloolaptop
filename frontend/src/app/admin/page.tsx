...
import { Activity, CreditCard, DollarSign, Package, ShoppingCart, UserPlus, Users } from 'lucide-react'
    ...
    <div className="p-6 space-y-6">
      ...
      >
        <TabsList>
          ...
          <TabsTrigger value="notifications">اطلاعیه‌ها</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="analytics">
          <Card>
            <CardHeader>
              <CardTitle>تحلیل‌های پیشرفته</CardTitle>
              <CardDescription>این بخش در حال توسعه است...</CardDescription>
            </CardHeader>
          </Card>
        </TabsContent>
      </Tabs>
